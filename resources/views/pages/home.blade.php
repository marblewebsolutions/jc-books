<div class="content-container">
    <div class="box">
        <div class="box-content">
            ...
            <p class="mt-med">I hope you enjoy previewing my first book, Ants in the Pants Dance! This rhyming story about a young boy with some uninvited guests in his picnic is engaging and fun!  This book is ideal for children ages 3-10.</p>
    
            <p class="mt-med">Look for my next book, Mirabelle the Butterfly to be released in early 2019.  Mirabelle is a young elephant who is determined to become a butterfly.  This enduring tale of belief in oneself appeals to a younger audience between the ages of 3-7.</p>
    ...
    <div class="box">
        <h2 class="box-title">Recent News:</h2>
        
        <div class="box-content">
            <p>Ants in the Pants Dance celebrated its book launch at an Open House at Dusty’s Cellar in Okemos MI in mid-September.  Attendees had opportunity to preview the book and purchase signed copies.</p>
